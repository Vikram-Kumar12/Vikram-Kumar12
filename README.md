...
Unlike the typical student journey, I bridge the gap between academic theory and real-world application. I don't just build tutorials,
I build solutions for clients and explore the bleeding edge of **Generative AI**.
...
| Project | Description |
| :--- | :--- |
| **[Digital Guru](https://digitalguru.app)** | <ul><li>Engineered a responsive and animation-rich agency website using **React.js**, **Tailwind CSS**, **Framer Motion88, and **GSAP**.</li><li>Improved user engagement by integrating streamlined animations, interactive UI components, and accessibility enhancements.</li><li>Translated design prototypes into scalable, reusable components and collaborated with the team to deliver high-quality features on time.</li></ul> |
